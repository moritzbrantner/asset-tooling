...
export function convolveRgba8(sourceValue, kernelValue) {
      ...
      for (let component = 0; component < 3; component += 1) {
        ...
        for (let kernelY = 0; kernelY < kernel.height; kernelY += 1) {
          ...
          for (let kernelX = 0; kernelX < kernel.width; kernelX += 1) {
            ...
            const weight = kernel.weights[kernelY * kernel.width + kernelX];
            sum += source.pixels[sourceOffset + component] * weight;
          }
        }
...
export function boxBlurRgba8(sourceValue, radius) {
  ...
  return convolveRgba8(sourceValue, {
    width: size,
    height: size,
